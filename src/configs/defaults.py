...
# MYTTA Configs
_C.ADAPTER.MYTTA = CN()
_C.ADAPTER.MYTTA.STMEM_CAPACITY = 16
_C.ADAPTER.MYTTA.STMEM_MAX_CLUS = 5
_C.ADAPTER.MYTTA.STMEM_TOPK_CLUS = 3
_C.ADAPTER.MYTTA.BASE_THRESHOLD = 1.0
_C.ADAPTER.MYTTA.LTMEM_MAX_CLUS = 1
_C.ADAPTER.MYTTA.LTMEM_CAPACITY = 32
